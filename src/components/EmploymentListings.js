...
import { employmentListings } from "../actions/employmentListingsAction";
import { searchAllListings } from "../actions/searchAllListingsAction";

class EmploymentListings extends Component {
  navigateTo = (screen, params) =>
    this.props.navigation.navigate(screen, params);

  componentDidMount = async () => {
    await this.props.employmentListings();
    this.renderData();
  };
  ...
  render() {
    ...
    const Item = ({
      ...
      <>
        {buttonPress && searchTerm && bucket.name !== "Employment" ? (
          <Text style={noListingTextStyle}>
            No Listing under Employment for {searchTerm}
          </Text>
        ) : (
          <TouchableOpacity
            onPress={() =>
...
const mapStateToProps = (state) => ({
  loadingListing: state.employmentListingsReducer.loading,
  data: state.employmentListingsReducer.data,
