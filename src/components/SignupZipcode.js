...
class SignupZipcode extends Component {
  ...
  onSubmit = async () => {
    if (!this.state.zipcode) {
      ...
      this.navigateTo('SignupEmail', {transition: 'fadeIn'});
    }
  }

  render() {

    const { zipcode, buttonPress, borderColor, borderWidth } = this.state;
        ...
        <Card style={cardStyle}>
          <KeyboardAwareScrollView
            ...
            <Button
              ...
              // onPress={() => this.navigateTo('SignupEmail', {transition: 'fadeIn'})}
...
export default connect(mapStateToProps, { saveInfo })(SignupZipcode);
